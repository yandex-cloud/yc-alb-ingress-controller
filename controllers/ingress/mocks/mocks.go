...
// Source: github.com/yandex-cloud/yc-alb-ingress-controller/controllers/ingress (interfaces: GroupLoader,EngineBuilder,BackendGroupDeployer,StatusResolver)
...
import (
	...
	v1alpha1 "github.com/yandex-cloud/yc-alb-ingress-controller/api/v1alpha1"
	deploy "github.com/yandex-cloud/yc-alb-ingress-controller/pkg/deploy"
	k8s "github.com/yandex-cloud/yc-alb-ingress-controller/pkg/k8s"
	reconcile "github.com/yandex-cloud/yc-alb-ingress-controller/pkg/reconcile"
	yc "github.com/yandex-cloud/yc-alb-ingress-controller/pkg/yc"
...
func (m *MockEngineBuilder) Build(arg0 context.Context, arg1 *k8s.IngressGroup, arg2 *v1alpha1.IngressGroupSettings) (*reconcile.IngressGroupEngine, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BuildForSvc", arg0, arg1, arg2)
...
func (mr *MockEngineBuilderMockRecorder) Build(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BuildForSvc", reflect.TypeOf((*MockEngineBuilder)(nil).Build), arg0, arg1, arg2)
}
